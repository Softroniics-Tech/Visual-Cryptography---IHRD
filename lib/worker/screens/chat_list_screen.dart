            ...
            itemBuilder: (context, index) {
              ...
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  // Get last message from the lastMessages array
                  final lastMessages = List<Map<String, dynamic>>.from(
                      chatData['lastMessages'] ?? []);
                  final lastMessage = lastMessages.isNotEmpty
                      ? lastMessages.last['text'] ?? 'No messages'
                      : 'No messages';
                  final lastMessageTime = lastMessages.isNotEmpty
                      ? lastMessages.last['timestamp'] as Timestamp?
                      : null;
